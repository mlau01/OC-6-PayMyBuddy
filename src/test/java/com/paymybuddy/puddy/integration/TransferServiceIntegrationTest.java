...
public class TransferServiceIntegrationTest {
	...
	public void doTransferTest_shouldCreateNewTranferAndUpdateUserBalances() throws NotEnoughCreditException, InvalidAmountException {
		...
		//assertEquals(transmitterBalanceBfTransfer - (amount + (amount * 0.05)), transmitter.getBalance());
		assertEquals(recipientBalanceBfTransfer + amount, recipient.getBalance());
	}
}
